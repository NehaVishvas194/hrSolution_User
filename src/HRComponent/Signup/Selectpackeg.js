...
export default function Selectpackeg() {
    ...
    const fetchpackage = () => {
        axios.get(`${baseUrl}getActivePackages`)
            .then((response) => {
    ...
    const handleSignup = async () => {
        try {
            ...
            formData.append("company_name", location?.state?.inputData?.company_name || "");
            formData.append("Number_of_emp", location?.state?.inputData?.Number_of_emp || "");
    ...
    const handleSignupYear = async () => {
        ...
        try {
            ...
            const signupResponse = await axios.post(`${baseUrl}employeeSignup`, formData);
            ...
            if (signupResponse.status === 200) {
                ...
                const cancelUrl = "http://itdevelopmentservices.com/hrsolution/cancel-package/";
                const receiptUrl = "https://itdevelopmentservices.com/hrsolution/Success-Paymet";

                try {
                    const paymentResponse = await axios.get(
                        `${baseUrl}create_checkOut_session_for_package?cancelUrl=${cancelUrl}&receiptUrl=${receiptUrl}&client_id=${localStorage.getItem("clientId")}&package_id=${currentRadioValue}`
                    );
                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-lg-12'>
                            <ul className="nav nav-tabs navBtnMain mt-5" id="myTab" role="tablist">
                    ...
                    <div className="tab-content" id="myTabContent">
                        ...
                        > <div className="col-lg-8 offset-lg-2" id="price">
                                ...
                                <p className="text-center big mt-3">Get ready for more potential, more opportunity and more of everything you expect from internet service provider</p>
                            </div>
                            <div className="packList row mt-4">
                                {Array.isArray(pack.yearly_packages) && pack.yearly_packages.length > 0 ? (
                                                    ...
                                                    <label className="pack" htmlFor={`personal-${index}`}>
                                                        ...
                                                        <div className="features">
                                                            <ul>
                                                                ...
                                                                {info.features && typeof info.features === 'string'
                                                                    ? info.features.split(",").map((feature, i) => (
                        ...
                        >
                            <div className="col-lg-8 offset-lg-2" id="price">
                                ...
                                <p className="text-center big mt-3 mb-0 ">Get ready for more potential, more opportunity and more of everything you expect from internet provider</p>
                            </div>
                            <div className="packList row mt-4">
                                {Array.isArray(pack.weekly_packages) && pack.weekly_packages.length > 0 ? (
                                            ...
                                            <div className="col-md-3 my-3" key={index}>
                                                <div className="packContainer">
                                                    <input
                                                        ...
                                                        value={info.package_id}
                                                    />
                                                    <label className="pack" htmlFor={`personal2-${index}`}>
                                                        <div className="header">
                                                            <h2>{info.package_name}</h2>
                                                        </div>
                                                        <div className="price">
                                                            ...
                                                            <h5>{info.duration}</h5>
                                                            <strong className='durationWeek'>GST Included</strong>
