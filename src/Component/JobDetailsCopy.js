...
export default function JobDetailpage() {
  ...
  //   bgImage.src = letterheadImg;

  //   bgImage.onload = () => {
  //     // Add background image
  //     const imgWidthMm = 2480 * 0.264583; // Convert pixels to mm
  ...
  //     // Define padding and content layout
  ...
  //       html.replace(/<\/?[^>]+(>|$)/g, ""); // Removes HTML tags
  //     // Content Variables
  ...
  //     doc.text(Title, paddingLeft, yPosition);
  //     yPosition += 20;

  //     // Add job description
  //     doc.setFontSize(30);
  //     doc.text("Job Description", paddingLeft, yPosition);
  //     yPosition += 25;

  //     const wrappedDescription = doc.splitTextToSize(Description, contentWidth);
  //     if (yPosition + wrappedDescription.length * 10 > pageHeight - 20) {
  //       doc.addPage();
  //       doc.addImage(bgImage, "PNG", 0, 0, pageWidth, pageHeight);
  //       yPosition = paddingTop;
  //     }
  //     doc.text(wrappedDescription, paddingLeft, yPosition);
  //     yPosition += wrappedDescription.length * 25 + 25;

  //     // Add job responsibilities
  //     doc.setFontSize(30);
  //     doc.text("Job Responsibilities", paddingLeft, yPosition);
  //     yPosition += 20;

  //     const wrappedResponsibilities = doc.splitTextToSize(
  //       Responsibilities,
  //       contentWidth
  //     );
  //     if (yPosition + wrappedResponsibilities.length * 20 > pageHeight - 25) {
  //       doc.addPage();
  //       doc.addImage(bgImage, "PNG", 0, 0, pageWidth, pageHeight);
  //       yPosition = paddingTop;
  //     }
  //     doc.text(wrappedResponsibilities, paddingLeft, yPosition);
  //     yPosition += wrappedResponsibilities.length * 20;

  //     // Add more fields as needed
  //     doc.setFontSize(23);
  //     yPosition += 20;

  //     doc.text(`Company Name: ${information?.company_name}`, paddingLeft, yPosition);
  //     yPosition += 20;

  //     doc.text(`Company Industry: ${information?.company_Industry}`, paddingLeft, yPosition);
  //     yPosition += 20;

  //     doc.text(`Company Address: ${information?.company_address}`, paddingLeft, yPosition);
  //     yPosition += 20;

  //     doc.text(`Location: ${information?.location}`, paddingLeft, yPosition);
  //     yPosition += 20;

  //     doc.text(`Number of Employees Needed: ${information?.Number_of_emp_needed}`, paddingLeft, yPosition);
  //     yPosition += 20;

  //     doc.text(`Job Type: ${information?.job_type}`, paddingLeft, yPosition);
  //     yPosition += 20;

  //     doc.text(`Job Schedule: ${information?.job_schedule}`, paddingLeft, yPosition);
  //     yPosition += 20;

  //     doc.text(`Experience Required: ${information?.Experience} years`, paddingLeft, yPosition);
  //     yPosition += 20;
  ...
  //   // Draw golden background (left 30%)
  //   doc.setFillColor(218, 184, 89); // Golden Yellow
  //   doc.rect(0, 0, leftWidth, pageHeight, "F");

  //   // Draw blue border
  //   doc.setFillColor(2, 9, 80); // Dark Blue
  //   doc.rect(leftWidth, 0, blueBorderWidth, pageHeight, "F");

  //   // Fill the right part with #f9f8f8
  ...
  //   // Add "Contact Us" inside the golden section
  ...
  //   // Add job description
  //   doc.setFontSize(16);
  //   doc.text("Job Description", contentStartX, yPosition);
  //   yPosition += 5;

  //   doc.setFontSize(13);
  //   doc.setTextColor(102, 116, 136);
  //   const wrappedDescription = doc.splitTextToSize(Description, contentWidth);
  //   doc.text(wrappedDescription, contentStartX, yPosition);
  //   yPosition += wrappedDescription.length * 7 + 5;

  //   // Add job responsibilities
  //   doc.setFontSize(16);
  //   doc.setTextColor(0, 0, 0);
  //   doc.text("Job Responsibilities", contentStartX, yPosition);
  //   yPosition += 5;
  ...
  //     contentWidth
  //   );
  //   doc.text(wrappedResponsibilities, contentStartX, yPosition);
  //   yPosition += wrappedResponsibilities.length * 7 + 5;

  //   // Add more fields as needed
  //   doc.setFontSize(13);
  //   doc.text(
  //     `Company Name: ${information?.company_name}`,
  //     contentStartX,
  //     yPosition
  //   );
  //   yPosition += 10;
  ...
  //   doc.text(
  //     `Company Industry: ${information?.company_Industry}`,
  //     contentStartX,
  //     yPosition
  //   );
  //   yPosition += 10;

  //   // doc.text(`Company Address: ${information?.company_address}`, contentStartX, yPosition);
  //   // yPosition += 10;

  //   doc.text(
  //     `Location: ${information?.location?.join(",")}`,
  //     contentStartX,
  //     yPosition
  //   );
  //   yPosition += 10;
  ...
  //   doc.text(
  //     `Number of Employees Needed: ${information?.Number_of_emp_needed}`,
  //     contentStartX,
  //     yPosition
  //   );
  //   yPosition += 10;
  ...
  //   doc.text(
  //     `Experience Required: ${information?.Experience} years`,
  //     contentStartX,
  //     yPosition
  //   );
  //   yPosition += 10;
  ...
  //   );
  //   yPosition += 10;
  //   doc.text(`skills: ${information?.skills}`, contentStartX, yPosition);
  //   yPosition += 10;
