                        ...
                        <div className="col-lg-4 col-md-6 mb20">
                            <div className='serviceNew'>
                                ...
                                <div className='serviceContentNew pb-0 flex-grow-1'>
                                    ...
                                    <p>Enhance your HR with expert guidance from Smart Start SL Ltd.'s consultancy services.</p>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6 mb20">
                            <div className='serviceNew'>
                                ...
                                <div className='serviceContentNew pb-0 flex-grow-1'>
                                    ...
                                    <p>Boost employee growth with tailored learning and development programs from Smart Start SL Ltd.</p>
                                </div>
                                <div className='serviceContentNew position-relative'>
                        ...
                        <div className="col-lg-4 col-md-6 mb20">
                            <div className='serviceNew'>
                                ...
                                <div className='serviceContentNew pb-0 flex-grow-1'>
                                    ...
                                    <p>Discover elite female talent candidates through our specialised recruitment services.</p>
                                </div>
                                <div className='serviceContentNew position-relative'>
                        ...
                        <div className="col-lg-4 col-md-6 mb20">
                            <div className='serviceNew'>
                                ...
                                <div className='serviceContentNew pb-0 flex-grow-1'>
                                    ...
                                    <p>Optimize your HR with Smart Start SL Ltd.'s expert teleconsultation services.</p>
                                </div>
                                <div className='serviceContentNew position-relative'>
